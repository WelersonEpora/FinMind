...
|---|---|---|
| NOAA STAR — clima sobre o milho | `npm run backfill:noaa-vh` | Desde 1981, 18 requisições, ~45 s em dev. A coleta diária só relê o ano corrente e o anterior; a ordem entre as duas não importa (ADR 0025) |
