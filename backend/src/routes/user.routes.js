...
router.post("/users/:id/photo", requireAuth, requireRole("owner"), upload.single("photo"), userController.uploadUserPhoto);
router.delete("/users/:id/photo", requireAuth, requireRole("owner"), userController.removeUserPhoto);

// Ver a foto de qualquer usuário não precisa ser owner - só autenticado
